...
class VoteRepository extends ServiceEntityRepository
{
    ...
    public function getUserVoteForArticle(Article $article)
    {
        $voteUser = $this->findOneBy(['article' => $article, 'user' => $this->security->getUser()]);
        return $voteUser ? $voteUser->getVote() : 0 ;
    }
